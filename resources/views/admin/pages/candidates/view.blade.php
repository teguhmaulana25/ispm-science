...
@section('add')
    <a href="{{ route('candidates.index') }}" class="btn btn-success btn-xs">
        <i class="fa fa-arrow-circle-left"></i> Back
    </a>
@endsection
@section('breadcrumb')
	<li><a href="{{ route('candidates.index') }}">Candidate</a></li>
	...
	<div class="col-xs-12">
		...
		<div class="widget">
			...
			<div class="widget-body">
                <form action="{{ route('candidates.update', ['division' => $division, 'job_vacancy' => $job_vacancy]) }}" role="form" method="post" accept-charset="utf-8" id="form_candidate">
                    @csrf
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="interview_date" class="form-control" id="val_int_date" placeholder="ex: 2020/10/29" autocomplete="off">
                                </div>
                            </div>
