...
@endsection
@section('breadcrumb')
	<li class="active"><a>View All Candidates By Division </a></li>
@endsection
	...
	<div class="col-xs-12">
		...
		<div class="widget">
			...
			<div class="widget-body">
				<form action="{{ route('candidates.filter') }}" role="form" method="post" accept-charset="utf-8" class="form-horizontal">
					@csrf
					<!-- AREA NOTIF -->
...
@push('scripts')
    ...
    <script type="text/javascript">
		...
		$("#division_list").bind("change", function(e){
            ...
            $.ajax({
                url:"{{ route('candidates.job-vacancy') }}",
