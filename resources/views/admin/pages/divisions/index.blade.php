...
@section('title')Data Division @endsection
@section('add')
    <a href="{{ route('divisions.create') }}" class="btn btn-success btn-xs">
        <i class="fa fa-plus-circle"></i> Add Division
    </a>
@endsection
@section('breadcrumb')
