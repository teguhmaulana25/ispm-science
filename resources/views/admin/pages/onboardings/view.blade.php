                                ...
                                @if(count($data_candidate) > 0)
                                    ...
                                    @foreach ($data_candidate as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('onboarding.view-candidate', ['division'=>$division, 'job_vacancy'=>$job_vacancy,'candidate' => $item['candidate']->id]) }}" class="btn btn-info btn-block" target="_blank">
