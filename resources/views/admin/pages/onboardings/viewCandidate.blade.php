...
@section('add')
    <a href="{{ route('onboarding.view', ['division'=>$division, 'job_vacancy'=>$job_vacancy]) }}" class="btn btn-success btn-xs">
        <i class="fa fa-arrow-circle-left"></i> Back
    </a>
@endsection
@section('breadcrumb')
	<li><a href="{{ route('onboarding.view', ['division'=>$division, 'job_vacancy'=>$job_vacancy]) }}">Onboarding</a></li>
