...
@section('breadcrumb')
	...
	<li class="active"><a href="#">Add Division</a></li>
@endsection
	...
	<div class="col-xs-12">
		...
		<div class="widget">
			...
			<div class="widget-body">
                <form action="{{ route('divisions.store') }}" role="form" method="post" accept-charset="utf-8" class="form-horizontal">
                    @csrf
    
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }} name">
                        <label class="control-label col-md-2">Name</label>
                        <div class="col-md-5">
                            <input type="text" name="name" class="form-control" value="{{ Request::old('name') ?: '' }}" required="required" autofocus="autofocus" maxlength="45">
