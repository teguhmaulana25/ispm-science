            ...
            <tbody><tr>
              <td align="center" valign="top">
                ...
                <table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
                  <tbody>
                  <tr>
                    <td class="hero-subheader__content" style="font-size: 20px;line-height: 27px;color: #969696;padding: 40px 25px 60px 25px;text-align: left;" align="left">Dear {{ $name }},<br><br>We from DUMET School invite you to take part in the onboarding process. <br><br>
